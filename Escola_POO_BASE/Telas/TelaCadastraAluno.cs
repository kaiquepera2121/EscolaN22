    ...
    public partial class TelaCadastraAluno : Form
    {
        ...
        private void DgvUsuarios_SelectionChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (_alunoSelecionado.Ativo)
                {
                    BtnReativar.Enabled = false;
                    BtnReativar.BackColor = Color.IndianRed;
                }
                else if (_alunoSelecionado.Ativo == false)
                {
                    BtnReativar.Enabled = true;
                    BtnReativar.BackColor = Color.LightGreen;
                }
        ...
        private void BtnReativar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DialogResult dr = MessageBox.Show($"Você deseja adicionar esse aluno {_alunoSelecionado.Nome}?"
                   , "Add Aluno"
                   , MessageBoxButtons.YesNo
                   , MessageBoxIcon.Question);
                    if (dr == DialogResult.Yes)
